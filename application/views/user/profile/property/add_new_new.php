                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="radio-list">
                                            <label>
                                                <input type="radio" name="optionsRadios" id="optionsRadios1" value="option1" > Existing Client</label>
                                            <label>
                                                <input type="radio" name="optionsRadios" id="optionsRadios2" value="option2" checked> New Client </label>
                                        </div>
                                    </div>
                                </div>
                                <!--/span-->
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="checkbox-list">
                                            <label>
                                                <input type="checkbox" id="inlineCheckbox1" value="option1"> Future Opportunity</label>
                                            <label>
                                                <input type="checkbox" id="inlineCheckbox2" value="option2"> International Opportunity </label>
                                            <label>
                                                <input type="checkbox" id="inlineCheckbox3" value="option3"> Local Opportunity </label>
                                        </div>
                                    </div>
                                </div>
                                <!--/span-->
