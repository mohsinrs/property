...
<html lang="en" class="no-js">
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo base_url('/public/global/plugins/select2/select2.css') ?>"/>
        <link rel="stylesheet" type="text/css" href="<?php echo base_url('/public/global/plugins/datatables/plugins/bootstrap/dataTables.bootstrap.css') ?>"/>
    ...
    <body class="page-header-fixed page-quick-sidebar-over-content page-sidebar-closed-hide-logo page-container-bg-solid">
        ...
        <div class="page-container">
            <!-- BEGIN SIDEBAR -->
            <?php $this->load->view('user/layout/sidebar.php'); ?>
            <!-- END SIDEBAR -->
            <!-- BEGIN CONTENT -->
        ...
        <script type="text/javascript" src="<?php echo base_url('/public/global/plugins/jquery-validation/js/jquery.validate.min.js') ?>"></script>
        <script type="text/javascript" src="<?php echo base_url('/public/global/plugins/jquery-validation/js/additional-methods.min.js') ?>"></script>
        ...
        <script type="text/javascript" src="<?php echo base_url('/public/global/plugins/select2/select2.min.js') ?>"></script>
        <script type="text/javascript" src="<?php echo base_url('/public/global/plugins/datatables/media/js/jquery.dataTables.min.js') ?>"></script>
        <script type="text/javascript" src="<?php echo base_url('/public/global/plugins/datatables/plugins/bootstrap/dataTables.bootstrap.js') ?>"></script>
        ...
        <script src="<?php echo base_url('/public/admin/layout/scripts/quick-sidebar.js') ?>" type="text/javascript"></script>
        <script src="<?php echo base_url('/public/admin/layout/scripts/demo.js') ?>" type="text/javascript"></script>
        <script src="<?php echo base_url('/public/admin/pages/scripts/form-validation.js') ?>"></script>
