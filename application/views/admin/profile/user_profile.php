                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <p class="form-control-static">
                                                101-farid tower mall road lahore
                                            </p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <table class="table table-striped table-bordered table-hover" id="sample_1">
                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td>Rent</td>
                                <td>10/11/2015</td>
                                <td><span class="label label-sm label-primary">Pending</span></td>
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td><a href="#" class="btn btn-default btn-primary">View</a><a href="#" class="btn btn-default btn-danger">Delete</a></td>
                            </tr>
                            <tr class="odd gradeX">
                                <td>15644</td>
                                <td>House</td>
