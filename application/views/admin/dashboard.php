                                            ...
                                            <div class="scroller" style="height: 290px;" data-always-visible="1" data-rail-visible1="1">
                                                <div class="row">
                                                    <div class="col-md-6 user-info">
                                                        <img alt="" src="<?php echo base_url('/public/admin/layout/img/avatar.png') ?>" class="img-responsive"/>
                                                        <div class="details">
                                                            <div>
                                                                <a href="javascript:;">
                                                                    Robert Nilson </a>
                            ...
                            <div class="portlet light ">
                                ...
                                <div class="portlet-body" id="chats">
                                    <div class="scroller" style="height: 341px;" data-always-visible="1" data-rail-visible1="1">
                                        <ul class="chats">
                                            <li class="in">
                                                <img class="avatar" alt="" src="<?php echo base_url('/public/admin/layout/img/avatar1.jpg') ?>"/>
                                                <div class="message">
                                                    <span class="arrow">
                                                    </span>
                                            ...
                                            <li class="out">
                                                <img class="avatar" alt="" src="<?php echo base_url('/public/admin/layout/img/avatar2.jpg') ?>"/>
                                                <div class="message">
                                                    <span class="arrow">
                                                    </span>
                                                    <a href="javascript:;" class="name">
                                            ...
                                            <li class="out">
                                                <img class="avatar" alt="" src="<?php echo base_url('/public/admin/layout/img/avatar3.jpg') ?>"/>
                                                <div class="message">
                                                    <span class="arrow">
                                                    </span>
                                                    <a href="javascript:;" class="name">
