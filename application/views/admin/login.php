...
<html lang="en">
    ...
    <head>
        ...
        <link href="<?php echo base_url('/public/admin/pages/css/login.css') ?>" rel="stylesheet" type="text/css"/>
    ...
    <body class="login">
        ...
        <div class="logo">
            <a href="<?php echo base_url('admin/login') ?>">
                <img src="<?php echo base_url('/public/admin/layout/img/logo-big.png') ?>" alt=""/>
            </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" action="<?php echo base_url('admin/login/process') ?>" method="post">
        ...
        <script src="<?php echo base_url('/public/admin/pages/scripts/login.js') ?>" type="text/javascript"></script>
        <!-- END PAGE LEVEL SCRIPTS -->
        <script>
